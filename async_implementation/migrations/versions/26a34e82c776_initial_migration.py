...
Revision ID: 26a34e82c776
Revises: 
Create Date: 2026-03-16 07:52:49.109633
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['sesion_id'], ['blog_sessions.id'], name=op.f('fk_blog_views_sesion_id_blog_sessions')),
