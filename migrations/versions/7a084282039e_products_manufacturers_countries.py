...
Revision ID: 7a084282039e
Revises:
Create Date: 2025-10-08 08:38:18.883895
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("manufacturers", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_manufacturers_name"), ["name"], unique=True
        )
    ...
    with op.batch_alter_table("products", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_products_manufacturer_id"), ["manufacturer_id"], unique=False
        )
